...
#the matrix is this grid. 
#the circle is the 'i', yk like a for i in list()
#the + is something already checked.

#make a copy of the actuall file with but # instead of numbers.
#make a data set, with the number in the top left corner, and replace the top left thing in the file with a circle.
